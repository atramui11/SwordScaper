...
class IntroScene: SKScene
{
	...
	override func didMove(to view: SKView)
	{
		...
		let x1 = -distanceBetweenTiles*2
		let yChar = distanceBetweenTiles*4
		createCharacter(charName: "bipin", name: "bipinNPC",position: CGPoint(x:x1,y:yChar),sprite: &bipinNPC)
	...
	func playDoorOpenSound()
	{
		...
		*/
		...
		guard Bundle.main.url(forResource: soundFile, withExtension: "wav") != nil else {
			print("url Not Found")
			return
		}
	...
	override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {if touches.first != nil {}}
